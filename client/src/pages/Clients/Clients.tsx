...
export const Clients: FunctionComponent = () => {
  const { apiMethodState, fetchData } = useApiMethod<ClientApp[], undefined>(
    appsApiDeclaration.getMyApps,
  );
  ...
  return (
    <div className="clients">
      ...
      <table>
        ...
        <tbody>{data ? Array.from(data).map(createAppItem) : []}</tbody>
      </table>
    </div>
  );
};
