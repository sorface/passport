...
import by.devpav.kotlin.oidcidp.dao.sql.model.client.ClientSettingModel
import by.devpav.kotlin.oidcidp.dao.sql.model.client.ClientTokenSettingModel
    ...
    override fun save(registeredClient: RegisteredClient) {
        val registeredClientModel = RegisteredClientModel().apply {
            ...
            redirectUris = registeredClient.redirectUris
                .mapNotNull { redirectUrl -> by.devpav.kotlin.oidcidp.dao.sql.model.client.ClientRedirectUrlModel().apply { this.url = redirectUrl } }
                .toMutableSet()
