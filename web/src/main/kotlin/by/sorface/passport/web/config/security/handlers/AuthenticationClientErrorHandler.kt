...
class AuthenticationClientErrorHandler(private val endpointOptions: EndpointOptions, private val localeService: LocaleService) : AuthenticationFailureHandler {
