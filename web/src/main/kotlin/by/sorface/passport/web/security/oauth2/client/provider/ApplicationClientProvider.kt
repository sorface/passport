package by.sorface.passport.web.security.oauth2.client.provider

import by.sorface.passport.web.config.options.ApplicationClientTokenProperties
import by.sorface.passport.web.config.options.ApplicationClientTokenProperties.TokenSetting
...
class ApplicationClientProvider(
    ...
    private val applicationClientTokenProperties: ApplicationClientTokenProperties
    ...
    private fun buildClient(oAuth2Client: OAuth2Client): RegisteredClient {
        ...
        val accessTokenSettings: TokenSetting = applicationClientTokenProperties.accessToken
        val refreshTokenSettings: TokenSetting = applicationClientTokenProperties.refreshToken
        val authorizationCodeSettings: TokenSetting = applicationClientTokenProperties.authorizationCode
