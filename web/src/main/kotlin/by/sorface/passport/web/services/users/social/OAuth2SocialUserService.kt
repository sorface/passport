...
interface SocialOAuth2UserService<T : SocialOAuth2User> {
...
@Service
open class GitHubOAuth2UserService(
...
@Service
open class GoogleOAuth2UserService(
    userService: UserService,
    roleService: RoleService
...
@Service
open class TwitchOAuth2UserService(
    userService: UserService,
    roleService: RoleService
...
@Service
open class YandexOAuth2UserService(
    userService: UserService,
    roleService: RoleService
...
abstract class AbstractSocialOAuth2UserService<T : SocialOAuth2User> protected constructor(
    ...
    private fun buildUserName(username: String?, id: String?): String? {
        val existUsername = if (username == null) false else userService.isExistUsername(username)
