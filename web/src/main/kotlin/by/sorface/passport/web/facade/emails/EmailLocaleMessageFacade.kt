...
class EmailLocaleMessageFacade(
    ...
    fun sendRenewPasswordEmail(locale: Locale?, recipient: String?, hash: String?, username: String?) {
        ...
        val emailTemplate = localeI18Service.getI18Message(I18Codes.I18EmailCodes.TEMPLATE_RENEW_PASSWORD)
        val subject = localeI18Service.getI18Message(I18Codes.I18EmailCodes.SUBJECT_TITLE_RESET_PASSWORD)
